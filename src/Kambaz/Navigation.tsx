  ...
  return (
    <div id="wd-kambaz-navigation" style={{ width: 120 }} 
      ...
      <Link to="/Kambaz/Account" 
            id="wd-account-link"
            className={`list-group-item text-center border-0 ${location.pathname === '/Kambaz/Account' ? 'bg-white text-danger' : 'bg-black text-white'}`}>
      ...
      <Link to="/Kambaz/Dashboard" 
            ...
            className={`list-group-item text-center border-0 ${location.pathname === '/Kambaz/Dashboard' ? 'bg-white text-danger' : 'bg-black text-white'}`}>
      ...
      <Link to="/Kambaz/Calendar" 
            id="wd-calendar-link"
            className={`list-group-item text-center border-0 ${location.pathname === '/Kambaz/Calendar' ? 'bg-white text-danger' : 'bg-black text-white'}`}>
      ...
      <Link to="/Kambaz/Inbox" 
            id="wd-inbox-link"
            className={`list-group-item text-center border-0 ${location.pathname === '/Kambaz/Inbox' ? 'bg-white text-danger' : 'bg-black text-white'}`}>
